...
for splits, dtype in ((1, "*bf16"), (8, "*fp32"), (2, "*fp32"), (5, "*fp32"), (4, "*fp32")):
    ...
    compile_kernel(_qk_rope_cache, sig, {"Q_HEADS": 32, "KV_HEADS": 8, "DIM": 128, "CAPACITY": 549, "Q_EPS": 1e-6, "K_EPS": 1e-6, "TOKENS": 4, "PREFILL": False, "BLOCK": 128, "ROWS": True, "SPLITS": splits}, num_warps=4)
